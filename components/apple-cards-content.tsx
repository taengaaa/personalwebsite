          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
              <span className="font-bold text-neutral-700 dark:text-neutral-200">
                Als Requirements Engineer verbinde ich Technik und Business.
              </span>{" "}
              Ich analysiere komplexe Anforderungen, erstelle klare Spezifikationen
              und sorge für eine reibungslose Kommunikation zwischen allen Stakeholdern.
            </p>
            <Image
...
const data = [
  ...
  },
  {
    ...
    src: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    content: <DummyContent />,
  },
];
